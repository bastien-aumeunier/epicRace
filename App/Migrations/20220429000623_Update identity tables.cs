        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PiloteId = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Car_AspNetUsers_PiloteId",
                        column: x => x.PiloteId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Races_AspNetUsers_PiloteId",
                        column: x => x.PiloteId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RaceResultId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResultItem", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResultItem_RaceResults_RaceResultId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Car_PiloteId",
                table: "Car",
                column: "PiloteId");

            migrationBuilder.CreateIndex(
                name: "IX_CarsType_CarId",
                table: "CarsType",
                column: "CarId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Races_PiloteId",
                table: "Races",
                column: "PiloteId");

            migrationBuilder.CreateIndex(
                name: "IX_ResultItem_RaceResultId",
                table: "ResultItem",
                column: "RaceResultId");
        }
